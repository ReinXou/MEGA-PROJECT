#=[ Recode boleh🙃 Tapi Sertakan Nama Gua yah ]=#
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r☠️ {P}[{b}{loop}{P}/{u}{len(id)}{P}]—{P}[{H}{ok}{P}]—{P}[{k}{cp}{x}]—[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
